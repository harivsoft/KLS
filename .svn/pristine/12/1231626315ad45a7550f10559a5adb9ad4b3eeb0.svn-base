...
<%@page import="com.vsoftcorp.kls.report.action.STMTLTDcbReportActionServlet"%>
<%@page import="org.apache.shiro.session.Session"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=STMTLTDcbReportActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
%><html>
<body>
	<form id="test">
		<table>
