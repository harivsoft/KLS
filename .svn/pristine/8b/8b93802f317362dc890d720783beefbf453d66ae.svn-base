...
<%@page import="com.vsoftcorp.kls.report.action.SanctionReportActionServlet"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=SanctionReportActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
%><html>
<body>
	<form id="test">
		<table>
