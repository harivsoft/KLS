...
<%@page import="com.vsoftcorp.kls.report.action.CollectionReportActionServlet"%>
<%@page import="org.eclipse.jdt.internal.core.util.MementoTokenizer"%><html>
<%@ page import="com.vsoftcorp.kls.report.util.CHtmlWriter"%>
...
String serverFileName=CollectionReportActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
