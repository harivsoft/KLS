...
<%@page import="com.vsoftcorp.kls.report.action.AccountStatementActionServlet"%>
<%@page import="java.util.*"%>
<%

String error = "<h1> Error Occured While Report Generation  </h1>";

String serverFileName=AccountStatementActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
