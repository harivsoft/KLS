...
<%@page import="com.vsoftcorp.kls.report.action.ScheduleVsGLBalanceActionServlet"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=ScheduleVsGLBalanceActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
%>
<html>
<body>
	<form id="test">
