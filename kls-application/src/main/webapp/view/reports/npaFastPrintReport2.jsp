...
<%@page import="com.vsoftcorp.kls.report.action.NPAReportActionServlet2"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=NPAReportActionServlet2.callFastPrint((String)session.getAttribute("txtFileName"));
%>
<html>
<body>
	<form id="test">
