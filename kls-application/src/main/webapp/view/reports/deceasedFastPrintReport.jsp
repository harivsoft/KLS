...
<%@page import="com.vsoftcorp.kls.report.action.DeceasedReportActionServlet"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=DeceasedReportActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
%><html>
<body>
	<form id="test">
		<table>
