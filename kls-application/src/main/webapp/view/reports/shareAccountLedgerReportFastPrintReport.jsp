...
<%@page import="com.vsoftcorp.kls.report.action.ShareAccountLedgerActionServlet"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=ShareAccountLedgerActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
%><html>
<body>
	<form id="test">
		<table>
