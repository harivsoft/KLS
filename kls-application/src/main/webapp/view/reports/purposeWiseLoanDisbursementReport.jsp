...
<%@page import="com.vsoftcorp.kls.report.action.PurposeWiseDisbursmentActionServlet"%>
<%@page import="java.util.*"%>
<%

String error = "<h1> Error Occured While Report Generation  </h1>";

String serverFileName=PurposeWiseDisbursmentActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
