...
<%@page import="com.vsoftcorp.kls.report.action.AccountAssignedSavingServlet"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=AccountAssignedSavingServlet.callFastPrint((String)session.getAttribute("txtFileName"));
%>
<html>
<body>
	<form id="test">
