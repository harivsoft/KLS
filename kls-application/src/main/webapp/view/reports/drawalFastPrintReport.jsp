...
<%@page import="com.vsoftcorp.kls.report.action.DrawalReportActionServlet"%>
...
String serverFileName=DrawalReportActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
