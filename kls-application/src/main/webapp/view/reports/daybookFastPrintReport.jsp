...
<%@page import="com.vsoftcorp.kls.report.action.DaybookReportActionServlet"%>
<%
String error = "<h1> Error Occured While Report Generation  </h1>";
String serverFileName=DaybookReportActionServlet.callFastPrint((String)session.getAttribute("txtFileName"));
%>
<html>
<body>
	<form id="test">
