...
public class CurrentTransaction implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "currentTxnIdSeq", sequenceName = "current_txn_id_seq", initialValue = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "currentTxnIdSeq")
	@Column(name = "id")
	private Long id;
